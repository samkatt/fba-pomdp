...
Domain_Feature_Size GridWorldCoffeeFBAExtension::domainFeatureSize() const
{
    ...
    return {{static_cast<int>(_size), static_cast<int>(_size), static_cast<int>(2), static_cast<int>(1)},
            {static_cast<int>(_size), static_cast<int>(_size), static_cast<int>(2), static_cast<int>(1)}};
}
